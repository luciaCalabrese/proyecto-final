...
public class director extends JFrame {
    ...
    public director() {
            ...
            listasBtn = new JButton("Listado " +
                    "Alumnos");


            cuestionariosBtn = new JButton("Ver " +
                    "cuestionarios");


            amonestacionesBtn = new JButton("Ver " +
                    "amonestaciones");
            ...
            horariosBtn = new JButton("Ver " +
                    "horarios");

            quejasBtn = new JButton("Ver " +
                    "quejas");
